...
with open('model_data/myModel_json.json', 'w') as json_file:
    json_file.write(model_json)
model.save_weights('model_data/myModel_weight.h5')
model.save('model_data/myModel.h5')

with open('model_data/fit_log.txt', 'wb') as file_txt:
